...
/**
 * Clase que contien el instrumento piano con las notas medias-altas
 * @author raul203al
 *
 */
public class PianoMedium extends JPanel {
	private ArrayList<Key> pianoKeys;



	public PianoMedium(Window w) {
		...
		a0.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.getKeyCode() == KeyEvent.VK_Q) {
					Instrument.playSound(pianoKeys.get(36).getNote());
					a0.setIcon(new ImageIcon(grayTile));
				}
				if (e.getKeyCode() == KeyEvent.VK_W) {
					Instrument.playSound(pianoKeys.get(37).getNote());
					as0.setIcon(new ImageIcon(grayBlackTile));
				}
				if (e.getKeyCode() == KeyEvent.VK_E) {
					Instrument.playSound(pianoKeys.get(38).getNote());
					b0.setIcon(new ImageIcon(grayTile));
				}

				if (e.getKeyCode() == KeyEvent.VK_R) {
					Instrument.playSound(pianoKeys.get(39).getNote());
					c1.setIcon(new ImageIcon(grayTile));
				}
				if (e.getKeyCode() == KeyEvent.VK_T) {
					Instrument.playSound(pianoKeys.get(40).getNote());
					cs1.setIcon(new ImageIcon(grayBlackTile));
				}
				if (e.getKeyCode() == KeyEvent.VK_Y) {
					Instrument.playSound(pianoKeys.get(41).getNote());
					d1.setIcon(new ImageIcon(grayTile));
				}

				if (e.getKeyCode() == KeyEvent.VK_U) {
					Instrument.playSound(pianoKeys.get(42).getNote());
					ds1.setIcon(new ImageIcon(grayBlackTile));
				}
				if (e.getKeyCode() == KeyEvent.VK_I) {
					Instrument.playSound(pianoKeys.get(43).getNote());
					e1.setIcon(new ImageIcon(grayTile));
				}
				if (e.getKeyCode() == KeyEvent.VK_O) {
					Instrument.playSound(pianoKeys.get(44).getNote());
					f1.setIcon(new ImageIcon(grayTile));
				}

				if (e.getKeyCode() == KeyEvent.VK_P) {
					Instrument.playSound(pianoKeys.get(45).getNote());
					fs1.setIcon(new ImageIcon(grayBlackTile));
				}
				if (e.getKeyCode() == KeyEvent.VK_A) {
					Instrument.playSound(pianoKeys.get(46).getNote());
					g1.setIcon(new ImageIcon(grayTile));
				}
				if (e.getKeyCode() == KeyEvent.VK_S) {
					Instrument.playSound(pianoKeys.get(47).getNote());
					gs1.setIcon(new ImageIcon(grayBlackTile));
				}

				if (e.getKeyCode() == KeyEvent.VK_D) {
					Instrument.playSound(pianoKeys.get(48).getNote());
					a1.setIcon(new ImageIcon(grayTile));
				}
				if (e.getKeyCode() == KeyEvent.VK_F) {
					Instrument.playSound(pianoKeys.get(49).getNote());
					as1.setIcon(new ImageIcon(grayBlackTile));
				}
				if (e.getKeyCode() == KeyEvent.VK_G) {
					Instrument.playSound(pianoKeys.get(50).getNote());
					b1.setIcon(new ImageIcon(grayTile));
				}

				if (e.getKeyCode() == KeyEvent.VK_H) {
					Instrument.playSound(pianoKeys.get(51).getNote());
					c2.setIcon(new ImageIcon(grayTile));
				}
				if (e.getKeyCode() == KeyEvent.VK_J) {
					Instrument.playSound(pianoKeys.get(52).getNote());
					cs2.setIcon(new ImageIcon(grayBlackTile));
				}
				if (e.getKeyCode() == KeyEvent.VK_K) {
					Instrument.playSound(pianoKeys.get(53).getNote());
					d2.setIcon(new ImageIcon(grayTile));
				}

				if (e.getKeyCode() == KeyEvent.VK_L) {
					Instrument.playSound(pianoKeys.get(54).getNote());
					ds2.setIcon(new ImageIcon(grayBlackTile));
				}
				if (e.getKeyCode() == KeyEvent.VK_Z) {
					Instrument.playSound(pianoKeys.get(55).getNote());
					e2.setIcon(new ImageIcon(grayTile));
				}
				if (e.getKeyCode() == KeyEvent.VK_X) {
					Instrument.playSound(pianoKeys.get(56).getNote());
					f2.setIcon(new ImageIcon(grayTile));
				}

				if (e.getKeyCode() == KeyEvent.VK_C) {
					Instrument.playSound(pianoKeys.get(57).getNote());
					fs2.setIcon(new ImageIcon(grayBlackTile));
				}
				if (e.getKeyCode() == KeyEvent.VK_V) {
					Instrument.playSound(pianoKeys.get(58).getNote());
					g2.setIcon(new ImageIcon(grayTile));
				}
				if (e.getKeyCode() == KeyEvent.VK_B) {
					Instrument.playSound(pianoKeys.get(59).getNote());
					gs2.setIcon(new ImageIcon(grayBlackTile));
				}

				if (e.getKeyCode() == KeyEvent.VK_N) {
					Instrument.playSound(pianoKeys.get(60).getNote());
					a2.setIcon(new ImageIcon(grayTile));
				}
				if (e.getKeyCode() == KeyEvent.VK_M) {
					Instrument.playSound(pianoKeys.get(61).getNote());
					as2.setIcon(new ImageIcon(grayBlackTile));
				}
				if (e.getKeyCode() == KeyEvent.VK_1) {
					Instrument.playSound(pianoKeys.get(62).getNote());
					b2.setIcon(new ImageIcon(grayTile));
				}

				if (e.getKeyCode() == KeyEvent.VK_2) {
					Instrument.playSound(pianoKeys.get(63).getNote());
					c3.setIcon(new ImageIcon(grayTile));
				}

				if (e.getKeyCode() == KeyEvent.VK_3) {
					Instrument.playSound(pianoKeys.get(64).getNote());
					cs3.setIcon(new ImageIcon(grayBlackTile));
				}

				if (e.getKeyCode() == KeyEvent.VK_4) {
					Instrument.playSound(pianoKeys.get(65).getNote());
					d3.setIcon(new ImageIcon(grayTile));
				}

				if (e.getKeyCode() == KeyEvent.VK_5) {
					Instrument.playSound(pianoKeys.get(66).getNote());
					ds3.setIcon(new ImageIcon(grayBlackTile));
				}

				if (e.getKeyCode() == KeyEvent.VK_6) {
					Instrument.playSound(pianoKeys.get(67).getNote());
					e3.setIcon(new ImageIcon(grayTile));
				}

				if (e.getKeyCode() == KeyEvent.VK_7) {
					Instrument.playSound(pianoKeys.get(68).getNote());
					f3.setIcon(new ImageIcon(grayTile));
				}

				if (e.getKeyCode() == KeyEvent.VK_8) {
					Instrument.playSound(pianoKeys.get(69).getNote());
					fs3.setIcon(new ImageIcon(grayBlackTile));
				}

				if (e.getKeyCode() == KeyEvent.VK_9) {
					Instrument.playSound(pianoKeys.get(70).getNote());
					g3.setIcon(new ImageIcon(grayTile));
				}

				if (e.getKeyCode() == KeyEvent.VK_0) {
					Instrument.playSound(pianoKeys.get(71).getNote());
